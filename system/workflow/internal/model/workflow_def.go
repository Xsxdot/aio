...
type WorkflowDefModel struct {
	common.Model
	Code    string `gorm:"column:code;size:100;not null;uniqueIndex:idx_code_version" json:"code" comment:"模板唯一标识"`
	Version int32  `gorm:"column:version;not null;default:1;uniqueIndex:idx_code_version" json:"version" comment:"版本号"`
